...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty isMoveJoystick;
    ...
    protected virtual void OnEnable()
    {
        ...
        isMoveJoystick = serializedObject.FindProperty("isMoveJoystick");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(isMoveJoystick, new GUIContent("isMoveJoystick", "Joystick type."));
    }
